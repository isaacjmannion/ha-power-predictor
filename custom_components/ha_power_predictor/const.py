...
DEFAULT_PEAK_END = 20  # local clock hour, inclusive
DEFAULT_PEAK_QUANTILE = 0.70
DEFAULT_OFFPEAK_QUANTILE = 0.80  # lifts the AR median-feedback trough on skewed loads (CV-tuned)
